...
terraform {
  ...
  source = "git@github.com:cdatai/line-level-data-collection-terraform.git//shared-infrastructure?ref=main"
  # for development
#  source = "/Users/david/Desktop/code/line-level-data-collection-platform/terraform-modules//shared-infrastructure"
}
...
inputs = {
  ...
  prefix      = "lldc"
  db_username = "db_user"
  module_name = "shared-infrastructure"
}
