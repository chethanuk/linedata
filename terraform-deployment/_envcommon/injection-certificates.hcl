...
terraform {
  ...
  source = "git@github.com:cdatai/line-level-data-collection-terraform.git//certificates?ref=main"
  # for development
#  source = "/Users/david/Desktop/code/line-level-data-collection-platform/terraform-modules//certificates"
}
