...
terraform {
  # change to this when going live
      source = "git@github.com:cdatai/line-level-data-collection-terraform.git//line-level-data-collection?ref=main"
  # for development
#      source = "/Users/david/Desktop/code/line-level-data-collection-platform/terraform-modules//line-level-data-collection"
}
